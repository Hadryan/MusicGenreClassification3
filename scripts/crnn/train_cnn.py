...
MODEL_NAME = "cnn_net_adam_" + EXP_NAME
...
# self.X_val, self.X_test, y_val, y_test = train_test_split(self.X_test, y_test, stratify=y_test, test_size=0.5)
...
model = MusicTaggerCNN(weights='msd', input_tensor=(1, 96, 1366), n_classes=nb_classes)
